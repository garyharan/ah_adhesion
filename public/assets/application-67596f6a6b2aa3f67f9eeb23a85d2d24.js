...
(function() {
  $(document).on("page:change", function() {
    $("td.help a.toggle_help").click(function(e) {
      var parent;
    ...
    $("label").on("click", function(e) {
      var answer, form, label, proof_files;
    ...
    return $(".answer_form").bind("ajax:success", function(xhr, data, status) {
      var upload_form;
      if ($(this).closest("table.question").find("tr.proof_files form").length < 0) {
        ...
        return upload_form.bind("ajax:success", function(e, data) {
          return $(this).closest("table.question").find("ul.addition").append(data);
        });
      }
    });
  });
...
(function() {
  $(function() {
    ...
    return $(".s3-uploader").bind("ajax:success", function(e, data) {
      return $(this).closest("table.question").find("ul.addition").append(data);
    });
  });
