...
(function() {
  $(document).on("page:change", function() {
    $(".help .help-toggle").click(function(e) {
      var parent;
    ...
    $(".s3-uploader").bind("ajax:success", function(e, data) {
      return $(this).closest("tr.question").find("ul.addition").append(data);
    });
    ...
    return $(".answer_form").bind("ajax:success", function(xhr, data, status) {
      ...
      if ($(this).closest(".question").find(".proof_files form.s3-uploader").length === 0) {
        ...
        return upload_form.bind("ajax:success", function(e, data) {
          return $(this).closest(".question").find("ul.addition").append(data);
        });
      }
    });
  });
