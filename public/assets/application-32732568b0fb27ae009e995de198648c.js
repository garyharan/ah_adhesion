  ...
  $(document).on("page:change", function() {
    ...
    Question = (function() {
      ...
      Question.prototype.setupDeleteAttachmentHandler = function() {
        return $(this.question).find(".delete_attachment").on("ajax:success", (function(_this) {
          return function(e) {
      ...
      Question.prototype.awsUploaderHandler = function() {
        ...
        return s3_uploader_form.bind("ajax:success", (function(_this) {
          return function(e, data) {
            ...
            $(_this.question).find("ul.addition a.delete_attachment").unbind("ajax:success");
            $(_this.question).find("ul.addition a.delete_attachment").on("ajax:success", function(e) {
              return $(e.target).closest("li").remove();
            });
    ...
    return $("tr.question").each(function(index) {
